...
export const TOOL_DOMAINS: ToolDomain[] = [
  {
    ...
    color: "green",
    tools: [
      { name: "get_access_users", desc: "List users" },
      { name: "get_access_user", desc: "Get by id, email, or external id" },
      { name: "create_user", desc: "Create user" },
      { name: "set_access_user_pin", desc: "Set door PIN" },
    ],
  },
  {
    label: "Doors",
    color: "orange",
    tools: [
      { name: "get_doors", desc: "List doors" },
      { name: "unlock_door", desc: "Remote unlock" },
    ],
  },
  {
    label: "Groups",
    color: "blue",
    tools: [
      { name: "get_access_groups", desc: "List groups" },
      { name: "get_access_group", desc: "Get group" },
      { name: "create_access_group", desc: "Create group" },
      { name: "delete_access_group", desc: "Delete group" },
      { name: "get_group_members", desc: "List members" },
      { name: "add_user_to_group", desc: "Add member" },
      { name: "remove_user_from_group", desc: "Remove member" },
    ],
  },
  {
    label: "Credentials",
    color: "yellow",
    tools: [
      { name: "add_access_card", desc: "Add card" },
      { name: "activate_access_card", desc: "Activate card" },
      { name: "delete_access_card", desc: "Delete card" },
      { name: "add_license_plate", desc: "Add plate" },
      { name: "delete_license_plate", desc: "Delete plate" },
    ],
  },
  {
    label: "Access levels",
    color: "red",
    tools: [
      { name: "get_access_levels", desc: "List levels" },
      { name: "get_access_level", desc: "Get level" },
      { name: "create_access_level", desc: "Create level" },
      { name: "delete_access_level", desc: "Delete level" },
      { name: "add_group_to_access_level", desc: "Grant group" },
      { name: "remove_group_from_access_level", desc: "Revoke group" },
    ],
  },
]
